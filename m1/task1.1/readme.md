...
19. ## Merge two new branches into develop using git merge command. Resolve conflict if it appear.
    ## Dit it in next sequence:•
...
26. ## Added task1.1_GIT.txt to my local repo in then Pushed it in GitHub repo.

    ![GitHub Logo](screens/26.png)

    ## File was put in [task1.1_GIT.txt](/m1/task1.1_GIT.txt)
