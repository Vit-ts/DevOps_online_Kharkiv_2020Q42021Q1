...
#### 1.Розставляємо на робочому полі необхідні вузли, використовуючи браузер в нижній частині вікна (рис. 1.1). З'єднуємо вузли відповідно до завдання за допомогою крученої пари.

| <img src = "screens/1_1.png"> |
|:--:|
| <b> Img. 1.1 - Робоче поле</b> |

#### 2. Задамо ip-адреси вузлів сегмента в діапазоні 192.168.0.х, а сервера, підключеного до маршрутизатора - 192.168.1.2. Маска підмережі -255.255.255.0. (Рис. 2.1)
